...
public record DogRecord(UUID dogId, ResourceKey<Level> dimension, BlockPos lastKnownPos,
                        ...
                        DyeColor collar, Optional<ResourceKey<WolfVariant>> variant) {
    ...
    public static final Codec<DogRecord> CODEC = RecordCodecBuilder.create(instance -> instance.group(
            ...
            DyeColor.CODEC.optionalFieldOf("collar", DyeColor.RED).forGetter(DogRecord::collar),
            ResourceKey.codec(Registries.WOLF_VARIANT).optionalFieldOf("variant").forGetter(DogRecord::variant)
