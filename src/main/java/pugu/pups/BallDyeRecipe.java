...
public class BallDyeRecipe extends CustomRecipe {
    ...
    public ItemStack assemble(CraftingInput input) {
        ...
        ItemStack result = new ItemStack(ModItems.BALL);
        result.set(DataComponents.DYED_COLOR, new DyedItemColor(color.getTextureDiffuseColor()));
        result.set(ModDataComponents.BALL_DYE_COLOR, color);

        return result;
    }

    @Override
    public RecipeSerializer<BallDyeRecipe> getSerializer() {
        return ModRecipes.BALL_DYE_SERIALIZER;
    }
}